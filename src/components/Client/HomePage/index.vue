            ...
            <div class="card">
                <div class="card-body">
                    <div class="row g-0">
                        ...
                        <div class="col-md-6">
                            <div class="card-body">
                                <h5 class="card-title mt-1 text-danger">ALOHA Resort</h5>
                                <h2 class="card-title">Relax in our Hotel Resort</h2>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <p style="height: 170px;">ALOHA Resort không chỉ là một khách
                                        ...
                                        <p style="height: 170px;">ALOHA Resort cung cấp đầy đủ tiện
                                            ích cao cấp như spa,
                                    ...
                                    <div class="col-lg-6">
                                        <p style="height: 170px;">Dịch vụ khách hàng tại ALOHA Resort
                                ...
                                <!-- <div class="row">
                                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                                            ...
                                            <div class="user-info ps-3">
                                                <p class="user-name mb-0">ALOHA Resort</p>
